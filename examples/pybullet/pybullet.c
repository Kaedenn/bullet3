...
static PyObject* pybullet_setPhysicsEngineParameter(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|diidiidiiddddiididdiidiidi", kwlist, &fixedTimeStep, &numSolverIterations, &useSplitImpulse, &splitImpulsePenetrationThreshold, &numSubSteps,
...
/*
static PyObject* pybullet_updateUserConstraint(PyObject* self, PyObject* args, PyObject *kwargs)
{
    return NULL;
}
*/
...
static PyMethodDef MethodDefs[] = {
    ...
    {"loadURDF",
     ...
     "baseOrientation=[0.,0.,0.,1.], useMaximalCoordinates=0, useFixedBase=0, "
     "flags=0, globalScaling=1.0, physicsClientId=0)\n"
    ...
    {"saveState",
     ...
     { "removeState", (PyCFunction)pybullet_removeState,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"removeCollisionShape",
     ...
     {"getMeshData", (PyCFunction)pybullet_getMeshData,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"addUserData",
     ...
     METH_VARARGS | METH_KEYWORDS,
     "addUserData(bodyUniqueId, key, value, linkIndex=-1, "
     "visualShapeIndex=-1, physicsClientId=0)\n"
    ...
    {"getUserDataId",
     ...
     METH_VARARGS | METH_KEYWORDS,
     "getUserDataId(bodyUniqueId, key, linkIndex=-1, visualShapeIndex=-1, "
     "physicsClientId=0)\n"
    ...
    {"getLinkState",
     ...
     { "getLinkStates", (PyCFunction)pybullet_getLinkStates,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"resetJointStateMultiDof",
     ...
     "Reset the state (position, velocity etc) for a joint on a body "
     "instantaneously, not through physics simulation."},
    {"resetJointStatesMultiDof", (PyCFunction)pybullet_resetJointStatesMultiDof,
     METH_VARARGS | METH_KEYWORDS,
...
#else
    m = Py_InitModule3("pybullet", MethodDefs, "Python bindings for Bullet");
#endif
...
#define AddConstant(name, val) PyModule_AddIntConstant(m, name, val)
    ...
    AddConstant("B3G_NUMLOCK", XK_KP_Num_Lock);
